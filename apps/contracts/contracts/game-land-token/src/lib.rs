...
impl GameLandToken {
    ...
    pub fn initialize(env: Env, treasury: Address, engine: Address, is_testnet: bool) {
        ...
        env.storage()
            .instance()
            .set(&DataKey::Name, &String::from_str(&env, "Equinox Land Token"));
        env.storage()
            .instance()
    ...
    pub fn name(env: Env) -> String {
        env.storage()
            .instance()
            .get(&DataKey::Name)
            .unwrap_or_else(|| String::from_str(&env, "Equinox Land Token"))
    }
...
mod tests {
    ...
    fn test_initialize() {
        ...
        assert_eq!(client.name(), String::from_str(&env, "Equinox Land Token"));
