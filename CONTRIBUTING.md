...
Thank you for your interest in contributing to Equinox. This guide covers everything you need to know to submit high-quality contributions - from forking the repository to getting your pull request merged.
...
**Equinox does not accept direct pushes to the main repository.** Every contribution - regardless of size - must go through a personal fork and a pull request.
...
- You open a pull request from your fork's branch into `equinox/equinox:develop`.
- You never push directly to `equinox/equinox` on any branch.
...
Equinox is a financial platform. The code must be production-grade. The following standards are non-negotiable.
...
Equinox runs five GitHub Actions workflows on every pull request. **All five must pass before a pull request can be merged.** No exceptions.
...
All pull requests must target `equinox/equinox:develop`. Never open a pull request targeting `main`.
