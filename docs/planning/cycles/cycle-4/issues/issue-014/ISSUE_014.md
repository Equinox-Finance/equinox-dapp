...
On-chain governance, community polls, and token voting. Pollar does not provide these features. Pollar integration for `apps/equinox-land` is covered separately by C5-008 (#840).
