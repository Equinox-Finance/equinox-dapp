...
This issue establishes the persistence layer for the Equinox DeFi RWA API using PostgreSQL and Drizzle ORM. Drizzle provides a TypeScript-first approach with excellent performance and type safety.
...
DATABASE_URL=postgresql://user:password@localhost:5432/equinox_defi
DATABASE_POOL_MIN=2
