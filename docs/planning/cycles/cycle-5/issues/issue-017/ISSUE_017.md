...
Two audiences need documentation for Equinox Land. Players need to understand the game rules and economy without reading a word about Stellar, Soroban, or smart contracts. Developers who want to contribute or run the game locally need a setup guide that works on a fresh machine.
