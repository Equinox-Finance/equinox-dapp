...
This contract is the economic heart of Equinox Land. Its correctness is critical: a bug in the escrow logic can result in permanently locked properties or stolen tokens.
