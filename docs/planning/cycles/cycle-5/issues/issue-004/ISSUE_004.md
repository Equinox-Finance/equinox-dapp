...
LAND is the in-game currency of Equinox Land. Players use it to buy properties, pay for improvements, and receive rental income. The token must be a standard Stellar SEP-41 compatible fungible token so that wallet integrations and future exchange listings work without custom code.
