...
Everything lives inside `apps/equinox-land`. No dependency on `apps/api`.
...
import type { GameEvent } from "@equinox/shared";
...
- Use a persistent server deployment (Railway, Fly.io) for the equinox-land app.
