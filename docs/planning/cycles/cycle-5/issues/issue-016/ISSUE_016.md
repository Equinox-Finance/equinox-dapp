...
Step 1: Welcome. A brief visual introduction to the game: what Equinox Land is, what properties are, what LAND is. Two sentences maximum per concept. A hero image or illustration of the city grid. A "Get Started" button to advance.
