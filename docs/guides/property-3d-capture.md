...
This guide explains how to capture, process, and generate 3D Gaussian Splatting files (.splat) for your property listings on Equinox. With 3D Gaussian Splatting, investors can virtually walk through your property and make more informed decisions.
...
## Uploading to Equinox

Once you have a validated .splat file:

1. **Upload Storage**
   - Equinox supports IPFS, AWS S3, or CloudFlare R2 URLs
...
3. **Troubleshooting URL Issues**
   - Ensure CORS headers allow cross-origin requests from equinox.example.com
...
- **Data Storage**: Equinox doesn't store .splat files; only URLs are stored
...
- Contact Equinox support if issue persists

## Advanced Topics

### Streaming Optimization

Equinox's viewer implements HTTP range requests to stream .splat files progressively. To ensure optimal performance:
...
3. Contact Equinox support for advanced multi-splat orchestration features
...
- **Equinox Support**: support@equinox.example.com

---

**Last Updated**: May 2026  
**Equinox 3D Viewer Version**: 1.0
